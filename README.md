...
{
  Lcd_cursor(&lcd,0,1);
  Lcd_string(&lcd,"MITHUN");

  Lcd_cursor(&lcd,1,1);
  Lcd_string(&lcd,"212224240088");
}
void SystemClock_Config(void)
{
...
## Output screen shots of proteus  :
 ...
 <img width="1755" height="1034" alt="image" src="https://github.com/user-attachments/assets/bb8f6604-d9e1-4d04-bdee-4b15853d25fe" />

 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 

 <img width="1164" height="1094" alt="image" src="https://github.com/user-attachments/assets/974570dc-57bd-4805-a589-df935e205000" />
